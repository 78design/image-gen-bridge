...
**点击直接下载：[image-gen-bridge-v1.8.3.zip](https://github.com/78design/image-gen-bridge/releases/download/v1.8.3/image-gen-bridge-v1.8.3.zip)**

或从 [GitHub Releases](https://github.com/78design/image-gen-bridge/releases/tag/v1.8.3) 页面下载：

```bash
# 解压
unzip image-gen-bridge-v1.8.3.zip
cd image-gen-bridge
